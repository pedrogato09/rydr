        ...
        <aside class="sidebar">
            <form action="" method="GET">
                ...
                foreach ($categoryOptions as $category) {
                    ...
                    echo "<label><input type='checkbox' name='category[]' value='" . htmlspecialchars($catId) . "' $checked> " . htmlspecialchars($catName) . "</label>";
                }
                ?>
                ...
                <span>€<?php echo isset($_GET['max_price']) ? (int)$_GET['max_price'] : 300; ?></span>

                <button type="submit">Filteren</button>
                <a href="ons-aanbod" class="button-primary" style="margin-left: 8px;">Reset</a>
            </form>
        </aside>
